...
void InitDiscord()
{
    ...
    discordPresence.state = "mc.FlexDojo.it";
    discordPresence.details = "Join Minecraft Server";
    discordPresence.largeImageKey = "logo_flex";
    discordPresence.largeImageText = "FlexDojo";
